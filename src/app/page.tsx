...
export default function Home() {
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center bg-white font-sans">
      <main className="flex flex-1 w-full flex-col items-center justify-between px-6 py-16">
        <Image
